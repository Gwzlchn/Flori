"""steps/utils/lang.py 的测试:正文主语言输出具体 ISO 代码。"""

from steps.utils.lang import detect_lang


def test_english_is_en():
    assert detect_lang("The quick brown fox jumps over the lazy dog. " * 4) == "en"
...
def test_french_is_fr():
    text = "La recherche scientifique permet de comprendre le monde et de construire des systèmes fiables. " * 4
