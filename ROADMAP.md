...
- [x] Step Manifest v1 完成权威（commit fence + staging/promote/manifest-last 提交协议、dual 读端与启动对账、确定性 skipped manifest、`.done` backfill 迁移工具;manifest-only 切换与阶段 D 清理待迁移工单执行）
